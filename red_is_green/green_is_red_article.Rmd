...
#### Abstract
By using data collected from candidates from the danish municipal election in 2017 and creating two indices - one for the traditional "socialist-capitalist" scale and one for a new "green" scale - I show that the two follow eachother very closely and are almost interchangeable. The "reddest" parties are indeed also the "greenest". 
...
I will asses the realiability of the indices by using Cronbach's Alpha. "Cronbach's alpha will generally increase as the intercorrelations among test items increase, and is thus known as an internal consistency estimate of reliability of test scores." (Wikipedia 2017-01-01). In plain english it measures if the items in the index pull in the same direction and can be considered indicators of the same underlying trend.

The standarized alpha for the "socialist-capitalist" index is **`r round(tax_alpha$total$std.alpha, 2)`** and the alpha will not increase if I drop any of the variables in the index:
...
Based on the alpha values for our two indices (both above .8) I can conclude that they have good reliability and are good indices. (Yockey 2008).
...
As you can see the two indices follow eachother very closely and they have a correlation of **`r my_cor`**, which is quite high.
...
#### Discussion   
I began the paper by introducing the question of wether the green movement was a sub-movement of the traditional socialist-capitalist ideology or a movement in its own right.
...
So it seems that the green environmentalist movement is not a movement in its own right, but rather a subset of the socialist-capitalist ideology.  This then begs the question: what can make two so apparently different policy areas such as taxation and the environment follow eachother so closely? 

The answer might lie in the *moral foundations theory* proposed by Jonathan Haidt and his colleagues and elaborated upon in his book *The Rightous Mind* (Haidt 2012a). 
...
Haidt later expanded the foundations (Haidt 2012a) to include a 6th one:
...
The points above are paraphrased from moralfoundations.org (moralfoundations.org 2018).

And it is this foundation that might shed some light on why socialism and environmentalism follow eachother so closely. 

Part of the socialist agenda is controlling agenda. Controlling the means of production, controlling certain behaviours and controlling people as we witnessed in socialist countries up through the 20th century. It is an agenda focused on the collective before the individual. Socialisms opposite, liberalism, on the other hand is focused on limiting control and government. It is an agenda focused on the individual before the collective. 

The green agenda is also a "limiting" or "controlling" agenda. It is an agenda focused on changing peoples behaviour or habits so the people behave in a certain way - ie. eats only organic, recycles or drive electric vehicles. 

It therefore makes sense that the "red" and the "green" movement share a common ground: the approximately same place on Haidts Liberty/oppression foundation.

Perhaps it is this common ground that we are actually measuring with the two indices. That would explain why they follow eachother so closely. Maybe it is the underlying theme of the collective vs the individual - liberty vs oppression - that our two indices are measuring. If this is true, then the green movement is not a separate movement but actually a submovement of the socialist and thereby collectivist movement.

#### Conclusion   
By creating an index to measure the postition of danish parties on the traditional "socialist-capitalist" scale and a new index to measure the parties position on a "green" scale we see that these follow eachother very closely. In a Danish context there does not seem to be a difference between red and green parties. They are in fact the same.
...
Enhedslisten (2018). Delprogram: Miljøkampen. Accessed: 2018-02-04 https://enhedslisten.dk/programmer/delprogram-miljoekampen

Haidt, Jonathan (2012a). The Righteous Mind: Why Good People Are Divided By Politics and Religion. New York: Pantheon Books.

Haidt, Jonanthan (2012b). Understanding Libertarian Morality: The Psychological Dispositions of Self-Identified Libertarians. Accessed 2018-02-04 https://doi.org/10.1371/journal.pone.0042366

moralfoundations.org (2018). Homepage. Accessed 2018-02-04 http://www.moralfoundations.org/

Pedersen, Søren Hviid (2014). De konservative og miljøet. Accessed: 2018-02-04 https://www.b.dk/kommentarer/de-konservative-og-miljoeet

Wikipedia (2018). Cronbach's alpha. Accessed: 2018-01-01 https://en.wikipedia.org/wiki/Cronbach%27s_alpha       
